export const IPC_CHANNELS = {
  ...
  NATIVE_STREAMER_START: "native-streamer:start",
  NATIVE_STREAMER_STOP: "native-streamer:stop",
  NATIVE_STREAMER_STATE_GET: "native-streamer:state-get",
  NATIVE_STREAMER_EVENT: "native-streamer:event",
